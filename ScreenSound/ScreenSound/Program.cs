...
void ExibirOpcoesDoMenu()
{
    ...
    switch (opcaoEscolhidaNumerica)
    {
        ...
        case 4: ExibirMediaDaBanda();
            break;
        case 0: Console.WriteLine("Tchau :D");
            break;
...
void AvaliarBanda()
{
    //digite qual banda que desaja avaliar
...
void ExibirMediaDaBanda()
{
    ...
    Console.Write("Qual banda voce deseja ver a média: ");
    string nomeDaBanda = Console.ReadLine()!;
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        List<int> notaDaBanda = bandasRegistradas[nomeDaBanda];
        Console.WriteLine($"A média da banda {nomeDaBanda} é {notaDaBanda.Average()}.");
        Console.WriteLine("Digite uma tecla para voltar ao menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
